...
final class WeeklyAdviceController extends AbstractController
{
    ...
    #[Route('/By_land/{landId}', methods:['GET'], requirements: ['landId' => '\d+'])]
    public function getWeeklyAdviceForLand(int $landId): JsonResponse
    {   
        ...
        $userWeatherData = $this->CurrAdvice->filterWeatherByLandIdForWeekly($weatherData, $landId);
